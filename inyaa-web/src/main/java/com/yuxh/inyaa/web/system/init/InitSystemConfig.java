package com.yuxh.inyaa.web.system.init;
...
public class InitSystemConfig implements ApplicationListener<ApplicationContextEvent>, Ordered {
    ...
    public void init() {
        ...
        java.util.List<Config> configList = configDao.selectList(null);
        ...
        java.util.List<AuthUser> authUsers = authUserDao.selectList(new LambdaQueryWrapper<AuthUser>().eq(AuthUser::getRoleId, RoleEnum.ADMIN.getRoleId()));
