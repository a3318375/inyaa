package com.yuxh.inyaa.web.plumemo.links.controller;
...
public class FriendshipLinkController {
    ...
    public Result saveFriendshipLink(@Validated({InsertLink.class}) @RequestBody FriendshipLinkVO friendshipLinkVO, org.springframework.validation.BindingResult result) {
