package com.yuxh.inyaa.web.plumemo.log.service.impl;
...
import com.byteblogs.plumemo.log.domain.po.AuthUserLog;
...
public class AuthUserLogServiceImpl extends BaseServiceImpl<AuthUserLogDao, AuthUserLog> implements AuthUserLogService {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(AuthUserLogServiceImpl.class);
    ...
    public Result<AuthUserLogVO> getLogsList(AuthUserLogVO authUserLogVO) {
        ...
        java.util.List<AuthUserLogVO> logVOList = authUserLogDao.selectLogsList(page, authUserLogVO);
