package com.yuxh.inyaa.web.plumemo.file.factory;
...
public class UploadFileFactory {
    ...
    private static final java.util.Map<String, UploadFileTemplateService> uploadFileServiceMap = new ConcurrentHashMap<>();
