package com.yuxh.inyaa.web.plumemo.category.controller;
...
public class TagsController {
    ...
    public Result getTagsAndArticleQuantityList(TagsVO tagsVO, org.springframework.validation.BindingResult result) {
    ...
    public Result saveTags(@Validated({Insert.class}) @RequestBody TagsVO tagsVO, org.springframework.validation.BindingResult result) {
        ThrowableUtils.checkParamArgument(result);
    ...
    public Result updateTags(@Validated({Update.class}) @RequestBody TagsVO tagsVO, org.springframework.validation.BindingResult result) {
        ThrowableUtils.checkParamArgument(result);
