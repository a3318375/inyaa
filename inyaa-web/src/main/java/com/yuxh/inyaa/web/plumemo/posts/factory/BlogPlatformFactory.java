package com.yuxh.inyaa.web.plumemo.posts.factory;
...
public class BlogPlatformFactory {
    ...
    private static final java.util.Map<String, BlogPlatformService> blogPlatformServiceMap = new ConcurrentHashMap<>();
