...
public class CategoryController {
    ...
    public Result saveCategory(@Validated({Insert.class}) @RequestBody CategoryVO categoryVO, org.springframework.validation.BindingResult result) {
    ...
    public Result updateCategory(@Validated({Update.class}) @RequestBody CategoryVO categoryVO, org.springframework.validation.BindingResult result) {
        ThrowableUtils.checkParamArgument(result);
