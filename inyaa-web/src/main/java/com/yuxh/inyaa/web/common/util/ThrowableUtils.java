package com.yuxh.inyaa.web.common.util;
...
public class ThrowableUtils {
     ...
     * @param result
     */
    public static void checkParamArgument(org.springframework.validation.BindingResult result) {
        if (result != null && result.hasErrors()) {
            StringBuilder sb = new StringBuilder();
            java.util.List<FieldError> errors = result.getFieldErrors();
