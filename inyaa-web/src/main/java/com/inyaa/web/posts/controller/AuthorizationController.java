...
public class AuthorizationController {
	...
	public String authorization_code_grant(Model model) {
		String[] messages = retrieveMessages("inyaa-client-auth-code");
	...
	public String client_credentials_grant(Model model) {
		String[] messages = retrieveMessages("inyaa-client-client-creds");
		model.addAttribute("messages", messages);
		return "index";
	}
	...
	public String password_grant(Model model) {
		String[] messages = retrieveMessages("inyaa-client-password");
		model.addAttribute("messages", messages);
		return "index";
	}
